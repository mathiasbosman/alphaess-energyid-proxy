...
import be.mathiasbosman.alphaessexport.config.AlphaessProperties.Endpoints;
import be.mathiasbosman.alphaessexport.domain.dto.LoginDto;
import be.mathiasbosman.alphaessexport.domain.response.LoginResponseEntity;
import be.mathiasbosman.alphaessexport.domain.response.LoginResponseEntity.LoginData;
import be.mathiasbosman.alphaessexport.domain.response.SticsByPeriodResponseEntity;
import be.mathiasbosman.alphaessexport.domain.response.SticsByPeriodResponseEntity.Statistics;
